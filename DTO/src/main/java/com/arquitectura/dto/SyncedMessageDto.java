...
/**
 * Representa un mensaje sincronizado que se envía al cliente durante el proceso
 * de {@code MESSAGE_SYNC}. Incluye los metadatos necesarios para que el
 * cliente pueda distinguir entre mensajes directos y de canal, así como el
 * nombre de los participantes relevantes.
 */
public class SyncedMessageDto {
